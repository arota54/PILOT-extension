...
def create_model(train_sequences, emb_matrix) : 
    ...
    plot_model(model, to_file=base_dir + 'word2vec/multiclass/CNN-results/CNN-model.png', show_shapes=True, show_layer_names=True)
...
plot_cm(predictions, y_test, base_dir + "word2vec/multiclass/CNN-results/")
plot_history(loss, accuracy, val_loss, val_accuracy, base_dir + "word2vec/multiclass/CNN-results/")



np.savetxt(base_dir + "word2vec/multiclass/CNN-results/CNN-Prediction.csv", predictions.T.astype(int), delimiter=",", fmt="%i")
np.savetxt(base_dir + "word2vec/multiclass/CNN-results/CNN-Truth.csv", y_test.T.astype(int), delimiter=",", fmt="%i")
np.savetxt(base_dir + "word2vec/multiclass/CNN-results/CNN-Loss.csv", loss.T.astype(float), delimiter=",", fmt="%f")
np.savetxt(base_dir + "word2vec/multiclass/CNN-results/CNN-Val_Loss.csv", val_loss.T.astype(float), delimiter=",", fmt="%f")
np.savetxt(base_dir + "word2vec/multiclass/CNN-results/CNN-Acc.csv", accuracy.T.astype(float), delimiter=",", fmt="%f")
np.savetxt(base_dir + "word2vec/multiclass/CNN-results/CNN-Val_Acc.csv", val_accuracy.T.astype(float), delimiter=",", fmt="%f")
